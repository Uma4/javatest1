...
public class Sample {
        public static void main(String[] args) {
                ...
                List<Employee> ll = Arrays.asList(new Employee(101, "Anuj", "AO", 20000),
                                ...
                                new Employee(104, "Dhanuj2", "BO", 5000), new Employee(104, "Anuj3", "AO", 18000),
                ...
                ll.stream().min(Comparator.comparing(Employee::getSalary))
                                .ifPresent(p -> System.out.println("Dept with lowest pay:" + p));

                ll.stream().collect(Collectors.groupingBy(Employee::getSalary)).values().stream()
                                .filter(m -> m.size() > 1)
